...
function Write() {
  ...
  return (
   <div className="write">
    ...
    <form action="" className="writeForm" onSubmit={hnadleSubmit}>
        ...
        <div className="writeFormGroup">
            <textarea placeholder='Tell...' type="text" className='writeInput writeText'onChange={(e) => setDesc(e.target.value)}/>
        </div>
